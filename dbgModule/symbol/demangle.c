...
static comp_t	*_dmgOname (info_t *);
static comp_t	*_dmgSname (info_t *);
...
static comp_t *_dmgSrcName (info_t *di)
{
	...
	/* tmp °¡ setting ÀÌ µÇÁö ¾Ê¾Ò´Ù¸é default set */
	if(tmp == NULL)
...
static comp_t *_dmgOname (info_t *di)
{
	char c1;
	char c2;
...
static comp_t *_dmgSname (info_t *di)
{
	di->expansion += 20;
