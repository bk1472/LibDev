...
/** @file pc_key.h
 *
 *	PC (Keyboard) KEY mapping definitions
 *
 *	@author		Baekwon Choi
 *	@version    1.0
 *	@date       2018. 3. 23
...
------------------------------------------------------------------------------*/
/*	PC Keyboard Escape Sequence Map for teraterm							  */
...
/* Edited special key */
#define		PC_KEY_BACKQT				0x33750001	// '`'
#define		PC_KEY_TILDE				0x33750002	// '~'
#define		PC_KEY_AT					0x33750003	// '@'
#define		PC_KEY_SHARP				0x33750004	// '#'
#define		PC_KEY_DOOLLER				0x33750005	// '$'
/*-----------------------------------------------------------------------------
 *	Macro Definitions
------------------------------------------------------------------------------*/
